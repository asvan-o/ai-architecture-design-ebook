...
export const lesson04FinalContent = {
  ...
  organizer: {
    ...
    labEnvironment: {
      ...
      versions: [
        ['Node.js', '22.x LTS', '수업환경 통일과 설치 결과 재현을 위한 기준'],
        ['Electron', '43.3.0', '43.x Stable 계열에서 실제 설치 버전 고정'],
        ['Electron Forge', '7.11.2', 'Windows 설치 프로그램 제작 버전 고정'],
        ['chokidar', '4.0.3', 'CommonJS 기반 파일 감시 버전 고정'],
      ],
      checklist: [
...
└─ 98_REVIEW/`,
    ...
    developmentCommands: [
      ['npm install', 'npm 자체의 의존성 설치 명령 · package.json script가 아님'],
